...
abstract class _$OpenCoreTVDatabase extends GeneratedDatabase {
  _$OpenCoreTVDatabase(QueryExecutor e) : super(e);
  $OpenCoreTVDatabaseManager get managers => $OpenCoreTVDatabaseManager(this);
...
class $$AppsTableTableManager extends RootTableManager<
  ...
  $$AppsTableTableManager(_$OpenCoreTVDatabase db, $AppsTable table)
...
class $$AppsTableFilterComposer
    extends FilterComposer<_$OpenCoreTVDatabase, $AppsTable> {
...
class $$AppsTableOrderingComposer
    extends OrderingComposer<_$OpenCoreTVDatabase, $AppsTable> {
...
class $$CategoriesTableTableManager extends RootTableManager<
  ...
  $$CategoriesTableTableManager(_$OpenCoreTVDatabase db, $CategoriesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$CategoriesTableFilterComposer
    extends FilterComposer<_$OpenCoreTVDatabase, $CategoriesTable> {
...
class $$CategoriesTableOrderingComposer
    extends OrderingComposer<_$OpenCoreTVDatabase, $CategoriesTable> {
...
class $$AppsCategoriesTableTableManager extends RootTableManager<
  ...
  $$AppsCategoriesTableTableManager(
      _$OpenCoreTVDatabase db, $AppsCategoriesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$AppsCategoriesTableFilterComposer
    extends FilterComposer<_$OpenCoreTVDatabase, $AppsCategoriesTable> {
...
class $$AppsCategoriesTableOrderingComposer
    extends OrderingComposer<_$OpenCoreTVDatabase, $AppsCategoriesTable> {
...
class $$LauncherSpacersTableTableManager extends RootTableManager<
  ...
  $$LauncherSpacersTableTableManager(
      _$OpenCoreTVDatabase db, $LauncherSpacersTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
...
class $$LauncherSpacersTableFilterComposer
    extends FilterComposer<_$OpenCoreTVDatabase, $LauncherSpacersTable> {
...
class $$LauncherSpacersTableOrderingComposer
    extends OrderingComposer<_$OpenCoreTVDatabase, $LauncherSpacersTable> {
...
class $OpenCoreTVDatabaseManager {
  final _$OpenCoreTVDatabase _db;
  $OpenCoreTVDatabaseManager(this._db);
