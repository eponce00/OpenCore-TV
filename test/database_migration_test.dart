...
void main() {
  ...
  test("upgrade from v1 to v5", () async {
    ...
    final db = OpenCoreTVDatabase(schema.newConnection());
    ...
    expect(app.packageName, "tv.opencore.launcher");
    expect(app.name, "OpenCoreTV");
    ...
    expect(appsCategory.appPackageName, "tv.opencore.launcher");
